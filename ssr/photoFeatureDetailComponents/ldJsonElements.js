...
async function ldJsonElement(contentDetails) {
    var oldHeader = `${contentDetails.PhotoFeatureTitle}`
    let replaceStr = /"/gi
    let replaceStr1 = /\\/gi
        ...
        {
            {
                ...
                "url":"${process.env.REACT_APP_FONT_DOMAIN_URL}photo-feature/news/${contentDetails.PhotoFeatureID}",
                "datePublished":"${contentDetails.create_date}",
                "mainEntityOfPage":{
                    "@type":"WebPage",
                    "@id":"${process.env.REACT_APP_FONT_DOMAIN_URL}photo-feature/news/${contentDetails.PhotoFeatureID}"
                },
                "publisher":{
                    "@type":"Organization",
                ...
                "author":[
                    {
                        "@type":"Person",
                        "givenName":"${contentDetails.Writer}",
                        "name":"${contentDetails.Writer}"
                    }
                ],
                "keywords":"${KeyWord}",
        ...
        {
            {
                ...
                "itemListElement":[
                    ...
                    },
                    {
                        ...
                        "position":2,
                        "item":{
                            "@id":"${process.env.REACT_APP_FONT_DOMAIN_URL}photo-feature",
                            "name":"ছবিঘর"
                        }
                    },
                    {
